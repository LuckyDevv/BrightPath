CREATE TABLE IF NOT EXISTS `goods` (
    ...
    `image_path` VARCHAR(500) NOT NULL COMMENT 'Путь к основному изображению',
    ...
    `sizes` VARCHAR(50) NOT NULL COMMENT 'Размер (длина)х(ширина)х(высота)',
    `weight` INT NOT NULL COMMENT 'Вес (масса) товара',
